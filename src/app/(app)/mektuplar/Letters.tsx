  ...
  return (
    <div>
      <div className="flex items-start justify-between gap-3 mb-5">
        <p className="font-hand text-lg text-ink-soft leading-snug pt-1">Bugünkü {yonelme(b.ad)} değil, yarınki {yonelme(b.ad)}. Bir tarih seç; o güne kadar mühürlü kalır.</p>
