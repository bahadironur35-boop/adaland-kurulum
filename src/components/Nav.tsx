...
import { Sparkles, MessageCircle, Camera, Clapperboard, Star, Ruler, Settings, Ellipsis, Heart, Search, Mic, Mail, BookOpen, Trash2, LogOut } from "lucide-react";
...
const MOBILE_MORE = [MAIN[4], MAIN[5], MAIN[6], MAIN[7], MAIN[8], TOOLS[0], TRASH, TOOLS[2]];
